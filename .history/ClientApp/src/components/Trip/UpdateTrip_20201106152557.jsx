...
class UpdateTrip extends Component {
    ...
    onSubmit(e){
        ...
        let tripObject = {
            ...
            dateCompleted: this.state.dateCompleted ? this.state.dateCompleted.toISOString() : null
        }

        axios.put("api/Trips/UpdateTrip", tripObject).then(result => {
            history.push('/trips');
        })
